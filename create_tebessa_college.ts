...
async function run() {
  ...
  const traineeMapping = [
    ...
    { trackId: 'track-15', nameAr: 'تست كاتب مدينة رئيسي', email: 'tebessa-sec-ville-principal@takwinpro.dz' },
    { trackId: 'track-16', nameAr: 'تست كاتب مدينة', email: 'tebessa-sec-ville@takwinpro.dz' },
