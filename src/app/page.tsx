...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fbf8f3]">
      ...
      <header className="border-b border-[#F3E4C9] bg-[#fbf8f3] z-10 sticky top-0">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-[#3E5C46] text-[#F3E4C9] p-2.5 rounded-full">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-semibold rounded-full border border-[#3E5C46] text-[#3E5C46] hover:bg-[#3E5C46] hover:text-[#F3E4C9] transition-colors"
            >
            ...
            {/* Sage Pill Register */}
            <Link href="/auth?tab=register" className="btn-pill-sage text-sm py-2 px-6">
              {t('register')}
            </Link>
          </div>
        </div>
      ...
      <section className="bg-grain relative overflow-hidden bg-gradient-to-br from-[#F3E4C9] via-[#fbf8f3] to-[#F3E4C9] py-20 lg:py-32 border-b border-[#F3E4C9]">
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Hero text */}
          <div className="lg:col-span-7 flex flex-col items-start gap-6 text-start">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#CCD67F]/45 text-[#3E5C46] rounded-full text-xs font-bold uppercase tracking-wider">
              <span className="w-2 h-2 rounded-full bg-[#3E5C46]"></span>
              الجزائر — الجمهورية الديمقراطية الشعبية
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#3E5C46] leading-[1.25] tracking-tight">
              {t('heroTitle')}
            </h1>
            
            <p className="text-lg md:text-xl text-[#5C7449] leading-relaxed max-w-2xl">
              {t('heroSubtitle')}
            </p>
            
            <p className="text-sm text-[#3E5C46] font-semibold">
              ⭐ {t('heroTagline')}
            </p>

            <div className="flex flex-wrap gap-4 mt-4 w-full sm:w-auto">
              <Link href="/auth?tab=register" className="btn-pill-sage text-base w-full sm:w-auto text-center">
                {t('ctaJoin')}
              </Link>
              <Link href="/auth" className="btn-pill-ghost text-base w-full sm:w-auto text-center">
                {t('ctaLogin')}
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            <div className="w-full max-w-md aspect-square bg-[#F3E4C9] p-8 flex flex-col justify-between relative overflow-hidden rounded-3xl border-2 border-[#5C7449]">
              ...
              <div className="z-10 my-6">
                <h3 className="text-2xl font-bold text-[#3E5C46] mb-2">
      ...
      <section className="py-20 lg:py-28 max-w-7xl mx-auto px-6 w-full">
        <div className="text-center mb-16 flex flex-col items-center gap-3">
          <span className="text-sm font-bold text-[#3E5C46] uppercase tracking-widest bg-[#F3E4C9] px-4 py-1 rounded-full">
            {t('featureTitle')}
          </span>
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#3E5C46]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#F3E4C9] p-8 flex flex-col gap-5 justify-between relative overflow-hidden rounded-2xl group transition-all duration-300 hover:bg-[#EBDCBE]">
            <div className="bg-[#3E5C46] text-[#F3E4C9] w-12 h-12 flex items-center justify-center rounded-xl">
      ...
      <div className="fixed bottom-4 left-4 right-4 sm:left-auto bg-[#3E5C46] text-[#F3E4C9] p-4 flex flex-wrap items-center gap-3 rounded-2xl shadow-xl z-50 border border-[#5C7449] max-w-xl">
        <span className="text-xs font-bold uppercase tracking-wider text-[#CCD67F] block border-b border-[#CCD67F] pb-1 w-full">
          ⚙️ لوحة تتبع العرض العميل (Demo Quick Hop)
        </span>
        <Link href="/" className="text-xs px-2.5 py-1 bg-[#5C7449] rounded hover:bg-[#fbf8f3] hover:text-[#3E5C46] transition-colors font-semibold">
          Landing Page
        </Link>
        <Link href="/auth" className="text-xs px-2.5 py-1 bg-[#5C7449] rounded hover:bg-[#fbf8f3] hover:text-[#3E5C46] transition-colors font-semibold">
          Sign In / Register
        </Link>
        <Link href="/super-admin" className="text-xs px-2.5 py-1 bg-[#5C7449] rounded hover:bg-[#fbf8f3] hover:text-[#3E5C46] transition-colors font-semibold">
          Super Admin Panel
        </Link>
        <Link href="/company" className="text-xs px-2.5 py-1 bg-[#5C7449] rounded hover:bg-[#fbf8f3] hover:text-[#3E5C46] transition-colors font-semibold">
          Company Panel
        </Link>
        <Link href="/trainee" className="text-xs px-2.5 py-1 bg-[#5C7449] rounded hover:bg-[#fbf8f3] hover:text-[#3E5C46] transition-colors font-semibold">
          Trainee View
        </Link>
        <Link href="/verify" className="text-xs px-2.5 py-1 bg-[#CCD67F] text-[#3E5C46] rounded hover:bg-[#fbf8f3] hover:text-[#3E5C46] transition-colors font-bold">
          Verify Portal
        </Link>
      </div>

      {/* 4. Footer Section */}
      <footer className="mt-auto bg-[#3E5C46] text-[#F3E4C9] py-16 border-t-4 border-[#CCD67F]">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 pt-6 border-t border-[#F3E4C9]/10 text-center text-xs text-[#F3E4C9]/50">
          {t('footerCopyright')}
        </div>
      </footer>
    </div>
